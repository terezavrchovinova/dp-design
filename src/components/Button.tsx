...
export const Button = ({
  ...
  const variants = {
    primary:
      'text-white bg-gradient-to-r from-[#ff6700] via-[#e70f00] to-[#b51600] bg-[length:200%_auto] bg-left hover:bg-right shadow-lg shadow-[#ff670080] hover:shadow-[#ff670060] hover:-translate-y-0.5',
    outline:
  ...
  const shine =
    variant === 'primary'
      ...
      : 'absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,103,0,0.1),transparent_70%)] opacity-0 hover:opacity-100 transition-opacity duration-300'
